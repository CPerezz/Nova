...
impl<G: GroupExt> AllocatedR1CSInstance<G> {
  ...
  pub fn alloc<CS: ConstraintSystem<<G as GroupExt>::Base>>(
    mut cs: CS,
...
impl<G: GroupExt> AllocatedRelaxedR1CSInstance<G> {
  ...
  /// W = E = 0, u = 0, X0 = X1 = 0
  pub fn default<CS: ConstraintSystem<<G as GroupExt>::Base>>(
    mut cs: CS,
    limb_width: usize,
    n_limbs: usize,
  ) -> Result<Self, SynthesisError> {
  ...
  /// E = 0, u = 1
  pub fn from_r1cs_instance<CS: ConstraintSystem<<G as GroupExt>::Base>>(
    mut cs: CS,
  ...
  /// Absorb the provided instance in the RO
  pub fn absorb_in_ro<CS: ConstraintSystem<<G as GroupExt>::Base>>(
    &self,
    mut cs: CS,
    ro: &mut G::ROCircuit,
  ...
  pub fn fold_with_r1cs<CS: ConstraintSystem<<G as GroupExt>::Base>>(
    &self,
    mut cs: CS,
